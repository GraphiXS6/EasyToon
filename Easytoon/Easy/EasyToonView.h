...
public:
	...
	void OnMemoryBtn(bool Saving, int Pos);
...
protected:
	...
	afx_msg void OnUpdateNextFrameNb(CCmdUI* pCmdUI);
	...
	afx_msg void OnText();
	afx_msg void OnUpdateMemoryBtn( CCmdUI* pCmdUI );
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
private:
	...
	void _CurrentFrameInterfaceToCopyBuffer( CRect rect );
	void _EndCopy();
